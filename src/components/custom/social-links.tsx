  ...
  return (
    <section className="flex gap-4">
      <Link href="https://www.linkedin.com/in/matthewpua/" aria-label="LinkedIn" className="group" target="_blank">
        <Linkedin size={20} className={cn(sharedClasses, "group-hover:fill-blue-600 group-hover:animate-wiggle group-hover:text-blue-600")} />
      </Link>
      <Link href="https://github.com/mattpua" aria-label="GitHub" className="group" target="_blank">
        <Github size={20} className={cn(sharedClasses, "group-hover:fill-gray-600 group-hover:animate-wiggle ")} />
      </Link>
      <Link href="https://x.com/yo_puaaa" aria-label="X (Twitter)" className="group" target="_blank">
        <Twitter size={20} className={cn(sharedClasses, "group-hover:fill-blue-600 group-hover:animate-wiggle group-hover:text-blue-600")} />
      </Link>
      <Link href="https://www.threads.com/@yo_puaaa" aria-label="Threads" className="group" target="_blank">
          <Instagram size={20} className={cn(sharedClasses, "group-hover:fill-pink-600 group-hover:animate-wiggle ")} />
      </Link>
      <Link href="mailto:contact@mattpua.com" aria-label="Email" className="group" target="_blank">
        <Mail size={20} className={cn(sharedClasses, "group-hover:animate-wiggle group-hover:text-green-500")} />
      </Link>
    </section>
  );
}